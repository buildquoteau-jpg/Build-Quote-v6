export default function FlyerPage() {
  return (
    <div className="min-h-screen bg-slate-800 font-sans antialiased">
      ...
      {/* TOP BAR */}
      <div className="bg-slate-900 px-6 sm:px-12 py-4 flex items-center justify-between">
      ...
      {/* HERO */}
      <div className="bg-slate-800 px-6 sm:px-12 pt-12 pb-12 text-white">
      ...
      {/* HOW IT WORKS */}
      <div className="bg-white px-6 sm:px-12 py-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={step.n} className="flex flex-col gap-3 p-5 rounded-xl bg-slate-50 border border-slate-200">
                <div className="inline-flex items-center self-start bg-orange-100 text-orange-600 text-xs font-bold px-3 py-1 rounded-full">
                  STEP {step.n}
                </div>
      ...
      {/* WHY BUILDQUOTE */}
      <div className="bg-slate-50 px-6 sm:px-12 py-12 border-t border-slate-200">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={card.title} className="flex flex-col border-t-4 border-orange-500 bg-white rounded-b-xl px-5 py-5 shadow-sm">
